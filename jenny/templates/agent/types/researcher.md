...
- When the material is long, write it to a file under the workspace with `write_file`
  and reference that path in your answer instead of pasting everything back.
