"""Motore di matching testo per ``EditFileTool`` (estratto da filesystem.py).

Funzioni pure di ricerca/allineamento del testo da sostituire: match esatti,
trim, normalizzazione virgolette curve, reindent come il match, e diagnostica
del quasi-match (finestra migliore via difflib). Nessuno stato, nessuna I/O.
"""
