...
from jenny.agent.progress_events import (
    ...
    invoke_on_progress,
    on_progress_accepts_reasoning,
    on_progress_accepts_tool_events,
)
from jenny.utils.helpers import IncrementalAnswerStepper, strip_think
...
class AgentProgressHook(AgentHook):
    ...
    def __init__(
        ...
        *,
        ...
        self._stepper = IncrementalAnswerStepper()
    ...
    async def on_stream(self, context: AgentHookContext, delta: str) -> None:
        incremental, emitted = await self._stepper.feed(delta, self.emit_reasoning)
        if emitted:
    ...
    async def emit_reasoning(self, reasoning_content: str | None) -> None:
        ...
        if (
            ...
            and on_progress_accepts_reasoning(self._on_progress)
        ):
