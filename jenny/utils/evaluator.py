...
async def evaluate_response(
    ...
    On any failure, falls back to ``default_notify``. Il parametro è
    obbligatorio: ogni chiamante deve dichiarare esplicitamente se il
    fallback è fail-open o fail-closed (l'heartbeat passa ``False``).
    """
    try:
